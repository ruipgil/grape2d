...
Grape2D.CanvasRenderer.prototype.renderImage=function(a,b,c,d,f,e,g,h,k){this.canvas.drawImage(a,b,c,d,f,e,g,h,k)};
...
Grape2D.WireframeRenderer.prototype.start=function(){this.renderer.start()};Grape2D.WireframeRenderer.prototype.end=function(){this.renderer.end()};Grape2D.WireframeRenderer.prototype.appendToDOMElement=function(a){this.renderer.appendToDOMElement(a)};Grape2D.WireframeRenderer.prototype.getDOMElement=function(){return this.renderer.getDOMElement()};Grape2D.WireframeRenderer.prototype.setStrokeColor=function(a){this.renderer.setStrokeColor(a)};Grape2D.WireframeRenderer.prototype.setFillColor=function(a){this.renderer.setFillColor(a)};Grape2D.Object2D=function(a){this.position=a.position||new Grape2D.Vector;this.visible=a.visible||!0;this.texture=a.texture;this.textureOffset=a.textureOffset||new Grape2D.Vector;this.texturePosition=new Grape2D.Vector;this.computeTexturePosition();this.boundingBox=a.boundingBox;this.boundingBoxOffset=a.boundingBoxOffset||new Grape2D.Vector;this.computeBoundingBoxPosition();this.castShadow=a.castShadow||!1;this.receiveLight=a.receiveLight||!1};
...
this.boundingBox.getPosition().add(this.boundingBoxOffset)},getBoundingBoxPosition:function(){return this.boundingBox.getPosition()},computeTexturePosition:function(){this.texturePosition.set(this.position).add(this.textureOffset)},getTexturePosition:function(){return this.texturePosition},render:function(a,b){a.renderObject2D(this,b)},update:function(a,b){}};Grape2D.Shape=function(a){a=a||{};this.position=a.position||new Grape2D.Vector};Grape2D.Shape.prototype={constructor:Grape2D.Shape,getPosition:function(){return this.position},setPosition:function(a){this.position.set(a)},render:function(a,b){},createBV:function(a){},getStaticType:function(){}};Grape2D.AABB=function(a){Grape2D.Shape.call(this,a);this.width=a.width;this.hwidth=this.width/2;this.height=a.height;this.hheight=this.height/2};Grape2D.AABB.prototype=Object.create(Grape2D.Shape.prototype);Grape2D.AABB.prototype.getWidth=function(){return this.width};Grape2D.AABB.prototype.getHeight=function(){return this.height};Grape2D.AABB.prototype.getHalfWidth=function(){return this.hwidth};Grape2D.AABB.prototype.getHalfHeight=function(){return this.hheight};
Grape2D.AABB.prototype.setWidth=function(a){this.width=a;this.hwidth=this.width/2};Grape2D.AABB.prototype.setHeight=function(a){this.hheight=this.height=a};Grape2D.AABB.prototype.render=function(a,b){a.renderAABB(this,b)};Grape2D.AABB.prototype.createBV=function(a){return a.createFromAABB(this)};Grape2D.AABB.prototype.getStaticType=function(){return Grape2D.AABB.TYPE};Grape2D.AABB.TYPE="AABB";Grape2D.Circle=function(a){Grape2D.Shape.call(this,a);this.radius=a.radius};Grape2D.Circle.prototype=Object.create(Grape2D.Shape.prototype);Grape2D.Circle.prototype.getRadius=function(){return this.radius};Grape2D.Circle.prototype.setRadius=function(a){this.radius=a};Grape2D.Circle.prototype.render=function(a,b){a.renderCircle(this,b)};Grape2D.Circle.prototype.createBV=function(a){return a.createFromCircle(this)};Grape2D.Circle.prototype.getStaticType=function(){return Grape2D.Circle.TYPE};
Grape2D.Circle.TYPE="Circle";Grape2D.Polygon=function(a){Grape2D.Shape.call(this,a);this.vertexList=a.vertexList};Grape2D.Polygon.prototype=Object.create(Grape2D.Shape.prototype);Grape2D.Polygon.prototype.getVertexList=function(){return this.vertexList};Grape2D.Polygon.prototype.setVertexList=function(a){this.vertexList=a};Grape2D.Polygon.prototype.render=function(a,b){a.renderPolygon(this,b)};Grape2D.Polygon.prototype.createBV=function(a){return a.createFromPolygon(this)};Grape2D.Polygon.prototype.getStaticType=function(){return Grape2D.Polygon.TYPE};
Grape2D.Polygon.TYPE="Polygon";Grape2D.InputManager=function(a){this.mouseUp=[];this.mouseDown=[];this.mouseMove=[];this.mouseOver=[];this.mouseOut=[];this.mouseWheel=[];this.resize=[];this.rendererBinding=a;this.bindToRenderer(a)};
...
Grape2D.SimpleMap.prototype.update=function(a,b){for(var c=0;c<this.objs.length;c++)this.objs[c].update(a,b)};Grape2D.SimpleMap.prototype.rebuild=function(){};Grape2D.CollisionChecker=function(){};Grape2D.CollisionChecker.prototype={constructor:Grape2D.CollisionChecker,aabbVsAabb:function(a,b){},aabbVsCircle:function(a,b){},aabbVsPolygon:function(a,b){},aabbVsPoint:function(a,b){},circleVsAabb:function(a,b){},circleVsCircle:function(a,b){},circleVsPolygon:function(a,b){},circleVsPoint:function(a,b){},polygonVsAabb:function(a,b){},polygonVsCircle:function(a,b){},polygonVsPolygon:function(a,b){},polygonVsPoint:function(a,b){}};Grape2D.GenericCollisionChecker=function(){};Grape2D.GenericCollisionChecker.prototype=Object.create(Grape2D.CollisionChecker);Grape2D.GenericCollisionChecker.prototype.aabbVsAabb=function(a,b){return Grape2D.Math.abs(b.getPosition().getX()-a.getPosition().getX())<=a.getHalfWidth()+b.getHalfWidth()&&Grape2D.Math.abs(b.getPosition().getY()-a.getPosition().getY())<=a.getHalfHeight()+b.getHalfHeight()};
...
Grape2D.GenericCollisionChecker.prototype.polygonVsPolygon=function(a,b){return!1};Grape2D.GenericCollisionChecker.prototype.polygonVsPoint=function(a,b){var c=a.getVertexList(),d=[],f,e;d.push(c[0].clone().sub(b));for(f=0;f<d.length;++f)if(e=(f+1)%d.length,0<e&&d.push(c[e].clone().sub(b)),d[e].getX()*d[f].getY()-d[f].getX()*d[e].getY())return!1;return!0};Grape2D.SATCollisionChecker=function(){};Grape2D.SATCollisionChecker.prototype=Object.create(Grape2D.GenericCollisionChecker.prototype);Grape2D.SATCollisionChecker.prototype.aabbVsPolygon=function(a,b){return!1};
Grape2D.SATCollisionChecker.prototype.polygonVsPolygon=function(a,b){for(var c=this.selectAxis(this.computeAxis(a.getVertexList()),this.computeAxis(b.getVertexList())),d=this.computeIntervals(a.getVertexList(),c),f=this.computeIntervals(b.getVertexList(),c),e,g=0;g<c.length;g++)if(e=Grape2D.Math.overlaps(d,f),0>e)return!1;return!0};
