...
Grape2D.Math.abs(this.x)&&Grape2D.Math.abs(a.y)==Grape2D.Math.abs(this.y)},distanceTo:function(a){return Grape2D.Math.sqrt(Grape2D.Math.sq(a.x-this.x)+Grape2D.Math.sq(a.y-this.y))},sqDistanceTo:function(a){return a.x*this.x+a.y*this.y},equals:function(a){return this.x==a.x&&this.y==a.y},clone:function(){return new Grape2D.Vector(this.x,this.y)},toString:function(){return"Grape2D.Vector ("+this.x+","+this.y+")"},use:function(a){this.x=a(this.x);this.y=a(this.y);return this},reset:function(){this.y=
this.x=0;return this}};Grape2D.Vector.createFromPoints=function(a,b){return new Grape2D.Vector(b.x-a.x,b.y-a.y)};Grape2D.Vector.createFromAngle=function(a,b){return new Grape2D.Vector(b*Grape2D.Math.cos(a),b*Grape2D.Math.sin(a))};Grape2D.Matrix=function(a,b,c,d,f,e,g,h,k){this.v=[];void 0!==a?this.v=[a,b,c,d,f,e,g,h,k]:this.identity()};
...
setStrokeColor:function(a){},setFillColor:function(a){},renderParticle:function(a,b){},renderLineSegment:function(a,b,c){}};Grape2D.Canvas=function(a){a=a||{};this.canvas=document.createElement("Canvas");this.canvas.width=a.width||300;this.canvas.height=a.height||150;this.halfWidth=this.canvas.width/2;this.halfHeight=this.canvas.height/2;this.context=this.canvas.getContext("2d")};
...
Grape2D.CanvasRenderer.prototype.renderLineSegment=function(a,b,c){a=c.wcsToViewport(this,a);b=c.wcsToViewport(this,b);this.canvas.beginPath();this.canvas.moveTo(a.getX(),a.getY());this.canvas.lineTo(b.getX(),b.getY());this.canvas.stroke()};Grape2D.WireframeRenderer=function(a){this.renderer=a};Grape2D.WireframeRenderer.prototype=Object.create(Grape2D.Renderer.prototype);Grape2D.WireframeRenderer.prototype.getWidth=function(){return this.renderer.getWidth()};Grape2D.WireframeRenderer.prototype.getHalfWidth=function(){return this.renderer.getHalfWidth()};Grape2D.WireframeRenderer.prototype.setWidth=function(a){this.renderer.setWidth(a)};Grape2D.WireframeRenderer.prototype.getHeight=function(){return this.renderer.getHeight()};
...
Grape2D.WASDController.prototype={constructor:Grape2D.WASDController,w:function(){},isW:function(){return this.wLock},a:function(){},isA:function(){return this.aLock},s:function(){},isS:function(){return this.sLock},d:function(){},isD:function(){return this.dLock},setup:function(){},tearDown:function(){},dispatch:function(){this.setup();this.wLock?this.w():this.sLock&&this.s();this.aLock?this.a():this.dLock&&this.d();this.tearDown()}};Grape2D.Camera=function(a){a=a||{};this.rscale=new Grape2D.Vector(1,1);this.scale=a.scale||new Grape2D.Vector(1,1);this.lookAt=a.lookAt||new Grape2D.Vector;this.transformation=a.transformation||new Grape2D.Matrix;this.cM=new Grape2D.Matrix;this.icM=new Grape2D.Matrix;this.computeMatrix()};
Grape2D.Camera.prototype={constructor:Grape2D.Camera,computeMatrix:function(){this.cM=this.transformation.clone();this.cM.v[0]*=this.scale.getX()*this.rscale.getX();this.cM.v[1]*=this.scale.getX()*this.rscale.getX();this.cM.v[2]*=this.scale.getX()*this.rscale.getX();this.cM.v[3]*=this.scale.getY()*this.rscale.getY();this.cM.v[4]*=this.scale.getY()*this.rscale.getY();this.cM.v[5]*=this.scale.getY()*this.rscale.getY();this.icM=this.cM.clone().invert()},wcsToViewport:function(a,b){var c=this.cM.multiplyByVector(b.clone().sub(this.getLookAt()));
c.setX(c.getX()+a.getHalfWidth());c.setY(c.getY()+a.getHalfHeight());return c},viewportToWcs:function(a,b){var c=b.clone();c.setX(c.getX()-a.getHalfWidth());c.setY(c.getY()-a.getHalfHeight());return c=this.icM.multiplyByVector(c).sub(this.getLookAt())},rescale:function(a){this.rscale.setX(a.getX()/this.scale.getX());this.rscale.setY(a.getY()/this.scale.getY());this.computeMatrix()},setLookAt:function(a){this.lookAt.set(a)},getLookAt:function(){return this.lookAt},getScale:function(){return this.scale},
...
Grape2D.GenericCollisionChecker.prototype.circleVsAabb=function(a,b){return this.aabbVsCircle(b,a)};Grape2D.GenericCollisionChecker.prototype.aabbVsRay=function(a,b){return!1};Grape2D.GenericCollisionChecker.prototype.circleVsRay=function(a,b){return!1};Grape2D.GenericCollisionChecker.prototype.polygonVsRay=function(a,b){return!1};
...
b,c)}};
Grape2D.CollisionDispatcher.dcache={AABB:{AABB:Grape2D.CollisionDispatcher.aabbVsAabb,Circle:Grape2D.CollisionDispatcher.aabbVsCircle,Polygon:Grape2D.CollisionDispatcher.aabbVsPolygon,Point:Grape2D.CollisionDispatcher.aabbVsPoint,Ray:Grape2D.CollisionDispatcher.aabbVsRay},Circle:{AABB:Grape2D.CollisionDispatcher.circleVsAabb,Circle:Grape2D.CollisionDispatcher.circleVsCircle,Polygon:Grape2D.CollisionDispatcher.circleVsPolygon,Point:Grape2D.CollisionDispatcher.circleVsPoint,Ray:Grape2D.CollisionDispatcher.circleVsRay},Polygon:{AABB:Grape2D.CollisionDispatcher.polygonVsAabb,
Circle:Grape2D.CollisionDispatcher.polygonVsCircle,Polygon:Grape2D.CollisionDispatcher.polygonVsPolygon,Point:Grape2D.CollisionDispatcher.polygonVsPoint,Ray:Grape2D.CollisionDispatcher.polygonVsRay}};Grape2D.CollisionCheckerSingleton={instance:new Grape2D.SATCollisionChecker,getCollisionChecker:function(){return Grape2D.CollisionCheckerSingleton.instance},setCollisionChecker:function(a){Grape2D.CollisionCheckerSingleton.instance=a},collide:function(a,b){return Grape2D.CollisionDispatcher.dispatch(Grape2D.CollisionCheckerSingleton.instance,a,b)}};Grape2D.BVHTree=function(){};Grape2D.BVHTree.prototype=Object.create(Grape2D.Map.prototype);Grape2D.TopDownBVHTree=function(a){this.objs=a||[];this.rootNode=null;this.objs.length&&this.rebuild()};Grape2D.TopDownBVHTree.prototype=Object.create(Grape2D.BVHTree.prototype);Grape2D.TopDownBVHTree.prototype.rebuild=function(){this.rootNode=new Grape2D.TopDownBVHNode(null,this.objs)};Grape2D.TopDownBVHTree.prototype.add=function(a){this.objs.push(a)};Grape2D.TopDownBVHTree.prototype.remove=function(a){this.objs.splice(this.objs.indexOf(a),1)};Grape2D.TopDownBVHTree.prototype.query=function(a){return this.rootNode.query(a)};
Grape2D.TopDownBVHTree.prototype.queryPoint=function(a){return this.rootNode.queryPoint(a)};Grape2D.TopDownBVHTree.prototype.queryRay=function(a){return this.rootNode.queryRay(a)};Grape2D.TopDownBVHTree.prototype.clear=function(){this.objs=[];this.rootNode=null};Grape2D.TopDownBVHTree.prototype.update=function(a,b){for(var c=0;c<this.objs.length;c++)this.objs[c].update(a,b)};Grape2D.TopDownBVHTree.prototype.getRootNode=function(){return this.rootNode};Grape2D.TopDownBVHTree.MAX_DEPTH=5;
