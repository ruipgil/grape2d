...
pow:Math.pow,clamp:function(a,b,c){return a<b?b:a>c?c:a},overlaps:function(a,b){return a.min<=b.min?a.max-b.min:Grape2D.Math.overlaps(b,a)},sq:function(a){return a*a}};Grape2D.Vector=function(a,b){this.x=a||0;this.y=b||0};
