...
Grape2D.Polygon.prototype.setPosition=function(a){Grape2D.Shape.prototype.setPosition.call(this,a);this.computeVertexList()};Grape2D.Polygon.TYPE="Polygon";Grape2D.InputManager=function(a){this.mouseUp=[];this.mouseDown=[];this.mouseMove=[];this.mouseOver=[];this.mouseOut=[];this.mouseWheel=[];this.resize=[];this.rendererBinding=a;this.bindToRenderer(a)};
...
Grape2D.SATCollisionChecker.prototype.aabbVsPolygon=function(a,b){var c=new Grape2D.Polygon({vertexList:[new Grape2D.Vector(a.getPosition().getX()-a.getHalfWidth(),a.getPosition().getY()+a.getHalfHeight()),new Grape2D.Vector(a.getPosition().getX()+a.getHalfWidth(),a.getPosition().getY()+a.getHalfHeight()),new Grape2D.Vector(a.getPosition().getX()+a.getHalfWidth(),a.getPosition().getY()-a.getHalfHeight()),new Grape2D.Vector(a.getPosition().getX()-a.getHalfWidth(),a.getPosition().getY()-a.getHalfHeight())]});
return this.polygonVsPolygon(c,b)};Grape2D.SATCollisionChecker.prototype.polygonVsPolygon=function(a,b){for(var c=this.computeAxis(a),d=this.computeAxis(b),c=this.selectAxis(c,d),d=this.computeIntervals(a.getComputedVertexList(),c),f=this.computeIntervals(b.getComputedVertexList(),c),e,g=0;g<c.length;g++)if(e=Grape2D.Math.overlaps(d[g],f[g]),0>e)return!1;return!0};
