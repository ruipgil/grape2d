'use strict';var Grape2D={version:"1.2.0-alpha"};(function(){for(var a=0,b=["ms","moz","webkit","o"],c=0;c<b.length&&!window.requestAnimationFrame;++c)window.requestAnimationFrame=window[b[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[c]+"CancelAnimationFrame"]||window[b[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(b,c){var e=(new Date).getTime(),g=Math.max(0,16-(e-a)),h=window.setTimeout(function(){b(e+g)},g);a=e+g;return h});window.cancelAnimationFrame||(window.cancelAnimationFrame=
function(a){clearTimeout(a)})})();Grape2D.utils={getDocumentSize:function(){return{width:window.innerWidth,height:window.innerHeight}}};Grape2D.utils.Clock=function(){this.frameCount=0;this.lastFrame=this.end=this.start=(new Date).getTime();this.timeEl=this.fps=0};Grape2D.utils.Clock.prototype={constructor:Grape2D.utils.Clock,update:function(){var a=(new Date).getTime(),b=a-this.lastFrame;this.frameCount++;this.timeEl+=b;1E3<=this.timeEl&&this.reset(a);this.lastFrame=a;return b},reset:function(a){this.fps=this.frameCount;this.frameCount=this.timeEl=0;this.end=a}};Grape2D.Math={PI:3.141592653589793,PIx2:6.283185307179586,PId2:1.5707963267948966,PId4:0.7853981633974483,PId6:0.5235987755982988,PId8:0.39269908169872414,abs:function(a){return Math.abs(a)},floor:function(a){return~~a},ceil:function(a){return Math.ceil(a)},round:function(a){return 0<=a?~~(a+0.5):~~(a-0.5)},randFloat:function(a,b){return b?a+Math.random()*(b-a):Math.random()*a},randInt:function(a,b){return Grape2D.Math.floor(Grape2D.Math.randFloat(a,b)+0.5)},cos:Math.cos,sin:Math.sin,tan:Math.tan,
sqrt:Math.sqrt,pow:Math.pow,min:Math.min,max:Math.max,clamp:function(a,b,c){return a<b?b:a>c?c:a},overlaps:function(a,b){return a.min<=b.min?a.max-b.min:Grape2D.Math.overlaps(b,a)},sq:function(a){return a*a}};Grape2D.Vector=function(a,b){this.x=a||0;this.y=b||0};
...
this.y)},toString:function(){return"Grape2D.Vector ("+this.x+","+this.y+")"},use:function(a){this.x=a(this.x);this.y=a(this.y);return this},reset:function(){this.y=this.x=0;return this},getStaticType:function(){return Grape2D.Vector.STATIC_TYPE}};Grape2D.Vector.createFromPoints=function(a,b){return new Grape2D.Vector(b.x-a.x,b.y-a.y)};Grape2D.Vector.createFromAngle=function(a,b){return new Grape2D.Vector(b*Grape2D.Math.cos(a),b*Grape2D.Math.sin(a))};Grape2D.Vector.STATIC_TYPE="Vector";Grape2D.Matrix=function(a,b,c,d,f,e,g,h,k){this.v=[];void 0!==a?this.v=[a,b,c,d,f,e,g,h,k]:this.identity()};
...
setStrokeColor:function(a){},setFillColor:function(a){},renderParticle:function(a,b){},renderLineSegment:function(a,b,c){},renderPoint:function(a,b){}};Grape2D.Canvas=function(a){a=a||{};this.canvas=document.createElement("Canvas");this.canvas.width=a.width||300;this.canvas.height=a.height||150;this.halfWidth=this.canvas.width/2;this.halfHeight=this.canvas.height/2;this.context=this.canvas.getContext("2d")};
...
Grape2D.CanvasRenderer.prototype.renderImage=function(a,b,c,d,f,e,g,h,k){this.canvas.drawImage(a,b,c,d,f,e,g,h,k)};Grape2D.CanvasRenderer.prototype.renderAABB=function(a,b){var c=b.wcsToViewport(this,a.getMin());this.canvas.strokeRect(c.x,c.y,a.getWidth()*b.getScale().x,a.getHeight()*b.getScale().y)};
...
Grape2D.CanvasRenderer.prototype.setFillColor=function(a){this.canvas.setFillStyle(a)};Grape2D.CanvasRenderer.prototype.renderParticle=function(a,b){var c=b.wcsToViewport(this,a.getPosition());this.canvas.beginPath();this.canvas.arc(c.x,c.y,1,0,Grape2D.Math.PIx2,!1);this.canvas.fill()};
...
Grape2D.InputManagerDragEvent.prototype.getStart=function(){return this.start};Grape2D.InputManagerDragEvent.prototype.getEnd=function(){return this.end};Grape2D.InputManagerDragEvent.prototype.getDelta=function(){return this.delta};Grape2D.WASDController=function(a){this.dLock=this.sLock=this.aLock=this.wLock=!1;this.im=new Grape2D.InputManager(a);var b=this;this.im.addKeyDown(Grape2D.InputManager.KEY.W,function(){b.sLock||(b.wLock=!0)});this.im.addKeyUp(Grape2D.InputManager.KEY.W,function(){b.wLock=!1});this.im.addKeyDown(Grape2D.InputManager.KEY.S,function(){b.wLock||(b.sLock=!0)});this.im.addKeyUp(Grape2D.InputManager.KEY.S,function(){b.sLock=!1});this.im.addKeyDown(Grape2D.InputManager.KEY.A,function(){b.dLock||(b.aLock=
!0)});this.im.addKeyUp(Grape2D.InputManager.KEY.A,function(){b.aLock=!1});this.im.addKeyDown(Grape2D.InputManager.KEY.D,function(){b.aLock||(b.dLock=!0)});this.im.addKeyUp(Grape2D.InputManager.KEY.D,function(){b.dLock=!1})};
Grape2D.WASDController.prototype={constructor:Grape2D.WASDController,w:function(){},isW:function(){return this.wLock},a:function(){},isA:function(){return this.aLock},s:function(){},isS:function(){return this.sLock},d:function(){},isD:function(){return this.dLock},setup:function(){},tearDown:function(){},dispatch:function(){this.setup();this.wLock?this.w():this.sLock&&this.s();this.aLock?this.a():this.dLock&&this.d();this.tearDown()}};Grape2D.Camera=function(a){a=a||{};this.scale=a.scale||new Grape2D.Vector(1,1);this.lookAt=a.lookAt||new Grape2D.Vector;this.transformation=a.transformation||new Grape2D.Matrix;this.cM=new Grape2D.Matrix;this.icM=new Grape2D.Matrix;this.computeMatrix()};
...
Grape2D.GenericCollisionChecker.prototype.aabbVsPolygon=function(a,b){return!1};Grape2D.GenericCollisionChecker.prototype.circleVsPolygon=function(a,b){for(var c=b.getComputedVertexList(),d=a.getPosition(),f=Grape2D.Math.sq(a.getRadius()),e=0;e<c.length;e++)if(c[e].sqDistanceTo(d)>=f)return!0;return!1};Grape2D.GenericCollisionChecker.prototype.polygonVsPolygon=function(a,b){return!1};
...
Grape2D.SATCollisionChecker.prototype.computeIntervals=function(a,b){for(var c=[],d=Infinity,f=-Infinity,e,g,h=0;h<b.length;h++){for(var d=Infinity,f=-Infinity,k=0;k<a.length;k++)e=a[k].dot(b[h]),g=a[(k+1)%a.length].dot(b[h]),e>f&&(f=e),e<d&&(d=e),g>f&&(f=g),g<d&&(d=e);c.push({min:d,max:f})}return c};
Grape2D.SATCollisionChecker.prototype.aabbVsRay=function(a,b){for(var c=b.getDirection().rightNormal(),d=Infinity,f=-Infinity,e,g=Grape2D.SATCollisionChecker.aabbToVertexList(a),h=0;h<g.length;h++)e=g[h].dot(c),e>f&&(f=e),e<d&&(d=e);e=b.getStart().dot(c);return d<=e&&e<=f?(f=b.getStart().getX(),e=b.getEnd().getX(),c=b.getStart().getY(),d=b.getEnd().getY(),f=f>e?{min:e,max:f}:{min:f,max:e},c=c>d?{min:d,max:c}:{min:c,max:d},0<=Grape2D.Math.overlaps(f,{min:a.getMinX(),max:a.getMaxX()})&&0<=Grape2D.Math.overlaps(c,
...
2;b<a.length;b++)this.bv=d.merge(this.bv,a[b].getBoundingBox());0<c.left.length&&(this.left=new Grape2D.TopDownBVHNode(this,c.left));0<c.right.length&&(this.right=new Grape2D.TopDownBVHNode(this,c.right))}}},isLeaf:function(){return this.leaf},getBoundingVolume:function(){return this.bv},getParent:function(){return this.parent},getObjects:function(){return this.objects},getLeft:function(){return this.left},getRight:function(){return this.right},query:function(a){var b=[],c;if(this.leaf)for(c=0;c<
this.objects.length;c++)Grape2D.CollisionCheckerSingleton.collide(this.objects[c].getBoundingBox(),a)&&b.push(this.objects[c]);else if(Grape2D.CollisionCheckerSingleton.collide(this.bv,a)){var d=this.left.query(a);for(c=0;c<d.length;c++)b.push(d[c]);d=this.right.query(a);for(c=0;c<d.length;c++)b.push(d[c])}return b},queryRay:function(a){var b;if(this.leaf)for(b=0;b<this.objects.length;b++){if(Grape2D.CollisionCheckerSingleton.collide(this.objects[b].getBoundingBox(),a))return this.objects[b]}else if(Grape2D.CollisionCheckerSingleton.collide(this.bv,
a)&&((b=this.left.queryRay(a))||(b=this.right.queryRay(a))))return b;return null},getDepth:function(){return this.depth}};Grape2D.BVHStrategy=function(){};Grape2D.BVHStrategy.prototype={constructor:Grape2D.BVHStrategy,solve:function(a){}};Grape2D.MedianCutBVHStrategy=function(){};Grape2D.MedianCutBVHStrategy.prototype=Object.create(Grape2D.BVHStrategy.prototype);
Grape2D.MedianCutBVHStrategy.prototype.solve=function(a){for(var b={left:[],right:[],endState:!1},c=Infinity,d=-Infinity,f=Infinity,e=-Infinity,g=0,h,k=0;k<a.length;k++)h=a[k].getBoundingBoxPosition(),c>h.getX()&&(c=h.getX()),d<h.getX()&&(d=h.getX()),f>h.getY()&&(f=h.getY()),e<h.getY()&&(e=h.getY());if(0===d-c&&0===e-f)return b.endState=!0,b;if(Grape2D.Math.abs(d)-Grape2D.Math.abs(c)>=Grape2D.Math.abs(e)-Grape2D.Math.abs(f))for(g=c+Grape2D.Math.abs((d-c)/2),k=0;k<a.length;k++)h=a[k].getBoundingBoxPosition(),
h.getX()>g?b.right.push(a[k]):b.left.push(a[k]);else for(g=f+Grape2D.Math.abs((e-f)/2),k=0;k<a.length;k++)h=a[k].getBoundingBoxPosition(),h.getY()>g?b.right.push(a[k]):b.left.push(a[k]);return b};Grape2D.BVHStrategySingleton={strategy:new Grape2D.MedianCutBVHStrategy,setStrategy:function(a){Grape2D.BVHStrategySingleton.strategy=a},getStrategy:function(){return Grape2D.BVHStrategySingleton.strategy}};Grape2D.BVFactory=function(){};Grape2D.BVFactory.prototype={constructor:Grape2D.BVFactory,createFromAABB:function(a){},createFromCircle:function(a){},createFromPolygon:function(a){},createSceneBV:function(a,b){},getPlaceHolder:function(){}};Grape2D.AabbBVFactory=function(){};Grape2D.AabbBVFactory.prototype=Object.create(Grape2D.BVFactory.prototype);Grape2D.AabbBVFactory.prototype.createFromAABB=function(a){return a};Grape2D.AabbBVFactory.prototype.createFromCircle=function(a){var b=2*a.getRadius();return new Grape2D.AABB({position:a.getPosition(),width:b,height:b})};
...
Grape2D.SimpleGame.prototype.setup=function(){};Grape2D.SimpleGame.prototype.start=function(){this.animate()};Grape2D.SimpleGame.prototype.stop=function(){cancelAnimationFrame(this.raf)};Grape2D.SimpleGame.prototype.render=function(){this.scene.render(this.renderer,this.camera)};Grape2D.SimpleGame.prototype.update=function(a){this.scene.update(a)};
Grape2D.SimpleGame.prototype.animate=function(){var a=this,b=this.clock.update();this.raf=requestAnimationFrame(function(){a.animate()});this.update(b);this.render();this.renderer.renderText("FPS: "+this.clock.fps,new Grape2D.Vector(10,10))};
