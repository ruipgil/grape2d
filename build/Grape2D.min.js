...
Grape2D.Math.abs(this.x)&&Grape2D.Math.abs(a.y)==Grape2D.Math.abs(this.y)},distanceTo:function(a){return Grape2D.Math.sqrt(Grape2D.Math.sq(a.x-this.x)+Grape2D.Math.sq(a.y-this.y))},sqDistanceTo:function(a){return a.x*this.x+a.y*this.y},xDistanceTo:function(a){return this.x>a.x?Grape2D.Math.abs(this.x-a.x):Grape2D.Math.abs(a.x-this.x)},yDistanceTo:function(a){return this.y>a.y?Grape2D.Math.abs(this.y-a.y):Grape2D.Math.abs(a.y-this.y)},equals:function(a){return this.x==a.x&&this.y==a.y},clone:function(){return new Grape2D.Vector(this.x,
this.y)},toString:function(){return"Grape2D.Vector ("+this.x+","+this.y+")"},use:function(a){this.x=a(this.x);this.y=a(this.y);return this},reset:function(){this.y=this.x=0;return this},getStaticType:function(){return Grape2D.Vector.STATIC_TYPE},isZero:function(){return 0==this.x&&0==this.y}};Grape2D.Vector.createFromPoints=function(a,b){return new Grape2D.Vector(b.x-a.x,b.y-a.y)};Grape2D.Vector.createFromAngle=function(a,b){return new Grape2D.Vector(b*Grape2D.Math.cos(a),b*Grape2D.Math.sin(a))};
Grape2D.Vector.lerp=function(a,b,c){return a.clone().add(b.clone().sub(a).multiplyByScalar(c))};Grape2D.Vector.STATIC_TYPE="Vector";Grape2D.Matrix=function(a,b,c,d,e,f,g,h,k){this.v=[];void 0!==a?this.v=[a,b,c,d,e,f,g,h,k]:this.identity()};
...
getDOMElement:function(){},setStrokeColor:function(a){},setFillColor:function(a){},renderParticle:function(a,b){},setTextFont:function(a){},renderLineSegment:function(a,b,c){},renderPoint:function(a,b){}};Grape2D.Canvas=function(a){a=a||{};this.canvas=document.createElement("Canvas");this.canvas.width=a.width||300;this.canvas.height=a.height||150;this.halfWidth=this.canvas.width/2;this.halfHeight=this.canvas.height/2;this.context=this.canvas.getContext("2d")};
...
Grape2D.NetworkObject2D.prototype.render=function(a,b){var c=Grape2D.SnapshotManagerSingleton.getSnapshotNetworkObject2D(this.id);c&&!c.getPosition().equals(this.getPosition())?(c=Grape2D.Vector.lerp(this.getPosition(),c.getPosition(),Grape2D.SnapshotManagerSingleton.getLerpPercent()),this.renderInterpolate(a,b,c)):Grape2D.Object2D.prototype.render.call(this,a,b)};Grape2D.NetworkObject2D.prototype.renderInterpolate=function(a,b,c){a.renderNetworkObject2D(this,c,b)};
Grape2D.NetworkObject2D.prototype.process=function(a){a.processNetworkObject2D(this)};Grape2D.NetworkObject2D.prototype.getId=function(){return this.id};Grape2D.NetworkObject2D.prototype.setId=function(a){this.id=a};Grape2D.NetworkObject2D.prototype.createNetworkClone=function(){return new Grape2D.SnapshotNetworkObject2D(this.id,this.getPosition().getX(),this.getPosition().getY())};Grape2D.Shape=function(a){a=a||{};this.position=a.position||new Grape2D.Vector};Grape2D.Shape.prototype={constructor:Grape2D.Shape,getPosition:function(){return this.position},setPosition:function(a){this.position.set(a)},render:function(a,b){},createBV:function(a){},getStaticType:function(){}};Grape2D.AABB=function(a){Grape2D.Shape.call(this,a);this.min=new Grape2D.Vector;this.max=new Grape2D.Vector;if(a.width&&a.height)this.setWidth(a.width),this.setHeight(a.height);else{var b=this.getPosition();this.min.setX(a.minX);this.min.setY(a.minY);this.max.setX(a.maxX);this.max.setY(a.maxY);b.setX(a.minX+(this.max.getX()-this.min.getX())/2);b.setY(a.minY+(this.max.getY()-this.min.getY())/2)}};Grape2D.AABB.prototype=Object.create(Grape2D.Shape.prototype);Grape2D.AABB.prototype.getMin=function(){return this.min};
...
Grape2D.Particle.prototype.update=function(a,b){this.velocity.setX(this.velocity.getX()+this.acceleration.getX()*a);this.velocity.setY(this.velocity.getY()+this.acceleration.getY()*a);this.position.setX(this.position.getX()+this.velocity.getX()*a);this.position.setY(this.position.getY()+this.velocity.getY()*a);this.lifeTime-=a};Grape2D.Ray=function(a,b,c){this.start=a;this.direction=b;this.length=c;this.end=b.clone().multiplyByScalar(c).add(a)};Grape2D.Ray.prototype={constructor:Grape2D.Ray,getStart:function(){return this.start},getDirection:function(){return this.direction},getLength:function(){return this.length},getEnd:function(){return this.end},getStaticType:function(){return Grape2D.Ray.STATIC_TYPE}};Grape2D.Ray.STATIC_TYPE="Ray";Grape2D.ParticleSystem=function(){Grape2D.Object2D.call(this,{texture:new Grape2D.VoidTexture,boundingBox:new Grape2D.AABB({width:0,height:0})});this.emitters=[];this.fields=[];this.miny=this.minx=Infinity;this.maxy=this.maxx=-Infinity};Grape2D.ParticleSystem.prototype=Object.create(Grape2D.Object2D.prototype);Grape2D.ParticleSystem.prototype.addEmitter=function(a){a.setParticleSystem(this);this.emitters.push(a)};
...
b)};this.ws.onclose=function(b){for(var c=0;c<a.oncloseCallback.length;c++)a.oncloseCallback[c](b)}},getMetrics:function(){return this.metrics},isOpen:function(){return this.ws.readyState==this.ws.OPEN}};Grape2D.WebSocketMetrics=function(a,b){this.ws=a;this.syncAc=this.pingSamplesReceived=this.pingAc=0;this.pingSamples=10;this.lastSent=this.lastReceived=this.start=this.bytesReceived=this.bytesSent=this.lastPing=this.pingValue=0;this.syncClock=b||new Grape2D.utils.SynchronizedClock;var c=this;this.ws.addOnOpen(function(){c.start=c.syncClock.getTime()});this.ws.addOnMessage(function(a){var b=a.length;c.bytesReceived+=b;c.lastReceived=b;0===a.indexOf(Grape2D.WebSocketMetrics.PING_PREFIX)&&c.pongReceived(a)});
this.ws.addOnSend(function(a){a=a.length;c.bytesSent+=a;c.lastSent=a})};
Grape2D.WebSocketMetrics.prototype={constructor:Grape2D.WebSocketMetrics,ping:function(){this.pingStop=!0;this.pongSamplesReceived=this.syncAc=this.pingAc=0;for(var a=this,b=this.pingSamples;0<b;b--)setTimeout(function(){a.ws.send(Grape2D.WebSocketMetrics.PING_PREFIX+" "+(new Date).getTime())},20*b)},pong:function(a){this.ws.send(a+" "+this.syncClock.getTime())},pongReceived:function(a){var b=(new Date).getTime(),c=a.split(" ");a=Number(c[1]);var c=Number(c[2]),d;d=b-a;this.pingAc+=d;this.syncAc+=
0.5*(c-a+(c-b))-0.5*d;this.pingSamplesReceived++;this.lastPing=b;this.pingSamplesReceived==this.pingSamples&&(this.pingValue=Grape2D.Math.ceil(this.pingAc/this.pingSamples),this.pingSamplesReceived=0,this.syncClock.sync(Grape2D.Math.floor(this.syncAc/this.pingSamples)))},getPing:function(){return this.pingValue},getLastPing:function(){return this.lastPing},getLastBytesSent:function(){return this.lastSent},getBytesSent:function(){return this.bytesSent},getBytesSentPerSec:function(){return this.bytesSent/
((new Date).getTime()-this.start)},getLastBytesReceived:function(){return this.lastReceived},getBytesReceived:function(){return this.bytesSent},getBytesReceivedPerSec:function(){return this.bytesReceived/((new Date).getTime()-this.start)}};Grape2D.WebSocketMetrics.PING_PREFIX="'";Grape2D.SnapshotHistory=function(a){this.cap=a||10;this.history=[]};
...
getCap:function(){return this.cap},setCap:function(a){for(this.cap=a;this.history.length>this.cap;)this.history.shift()}};Grape2D.LagSimulator=function(a){a=a||{};this.latency=a.latency||0;this.variation=a.variation||0};Grape2D.LagSimulator.prototype={constructor:Grape2D.LagSimulator,getLatency:function(){return this.latency},setLatency:function(a){this.latency=a},getVariation:function(){return this.variation},setVariation:function(a){this.variation=a},simulate:function(a){var b=Grape2D.Math.randInt(this.latency-this.variation,this.latency+this.variation);setTimeout(function(){a(b)},b)}};Grape2D.SnapshotManager=function(a,b,c){this.clock=a;this.history=b;this.lerp=c||100;this.iLerp=1/this.lerp;this.currentSnapshot=null;this.lerpPercent=0};
Grape2D.SnapshotManager.prototype={constructor:Grape2D.SnapshotManager,getSnapshot:function(){return this.currentSnapshot},getSnapshotNetworkObject2D:function(a){return this.currentSnapshot?this.currentSnapshot[a]:null},getLerpPercent:function(){return this.lerpPercent},update:function(){var a=this.clock.getTime();this.lerpPercent=(this.currentSnapshot=this.history.getBefore(a))?(a-this.lerp-this.currentSnapshot.getTime())/this.iLerp:0}};Grape2D.SnapshotManagerSingleton={instance:null,setInstance:function(a){Grape2D.SnapshotManagerSingleton.instance=a},getInstance:function(){return Grape2D.SnapshotManagerSingleton.instance},getSnapshotNetworkObject2D:function(a){return Grape2D.SnapshotManagerSingleton.instance.getSnapshotNetworkObject2D(a)},getLerpPercent:function(){return Grape2D.SnapshotManagerSingleton.instance.getLerpPercent()},update:function(){Grape2D.SnapshotManagerSingleton.instance.update()}};Grape2D.SnapshotNetworkObject2D=function(a,b,c){this.id=a;this.position=new Grape2D.Vector(b,c)};Grape2D.SnapshotNetworkObject2D.prototype={constructor:Grape2D.SnapshotNetworkObject2D,getId:function(){return this.id},getPosition:function(){return this.position},updateNetworkObject2D:function(a){}};Grape2D.SnapshotEvent=function(a){this.id=a};Grape2D.SnapshotEvent.prototype={constructor:Grape2D.SnapshotEvent,getId:function(){return this.id},fire:function(a){}};Grape2D.Snapshot=function(a,b,c){this.time=a;this.events=b||[];this.networkObjects=c||{}};
Grape2D.Snapshot.prototype={constructor:Grape2D.Snapshot,addEvent:function(a){this.events.push(a)},addSnapshotNetworkObject2D:function(a){this.networkObjects[a.getId()]=a},getTime:function(){return this.time},getEvents:function(){return this.events},getSnapshotNetworkObject2D:function(a){return this.networkObjects[a]},fireEvents:function(a){for(var b=0;b<this.events.length;b++)this.events[b].fire(a)},updateNetworkObject2D:function(a){for(var b in this.networkObjects)this.networkObjects[b].updateNetworkObject2D(a)},dispatch:function(a,
b){this.fireEvents(a);this.updateNetworkObject2D(b)}};Grape2D.utils.MessageDispatcher=function(){this.stack=[]};Grape2D.utils.MessageDispatcher.prototype={constructor:Grape2D.utils.MessageDispatcher,add:function(a,b){this.stack.push({regex:a,callback:b})},remove:function(a){a=a.toString();for(var b=0;b<this.stack.length;b++)this.stack[b].regex.toString()==a&&this.stack.splice(b,1)},dispatch:function(a,b){for(var c,d=0;d<this.stack.length;d++)c=this.stack[d],c.regex.test(a)&&this.stack[d].callback(a,b)}};Grape2D.utils.TimerDispatcher=function(){this.tm=[]};Grape2D.utils.TimerDispatcher.prototype={constructor:Grape2D.utils.TimerDispatcher,add:function(a,b,c){this.tm.push({interval:a,callback:b,remaining:a,remove:c||!1})},dispatch:function(a){for(var b,c=[],d=0;d<this.tm.length;d++)b=this.tm[d],b.remaining<=a?(b.callback(),b.remove?c.push(d):b.remaining=Grape2D.Math.clamp(b.interval-(b.remaining-a),0,b.interval)):b.remaining-=a;for(d=0;d<c.length;d++)this.tm.splice(c[d],1)}};
Grape2D.utils.TimerDispatcher.SECOND=1E3;Grape2D.utils.TimerDispatcher.MINUTE=60*Grape2D.utils.TimerDispatcher.SECOND;Grape2D.utils.TimerDispatcher.HOUR=60*Grape2D.utils.TimerDispatcher.MINUTE;Grape2D.TopDownBVHTreeDebugger={renderNode:function(a,b,c){a.getBoundingVolume().render(b,c);b.renderText(a.getDepth(),c.wcsToViewport(b,a.getBoundingVolume().getPosition()));a.getLeft()&&(b.setStrokeColor("rgba(0,255,0,0.6)"),Grape2D.TopDownBVHTreeDebugger.renderNode(a.getLeft(),b,c),b.setStrokeColor("rgba(0,0,0,1)"));a.getRight()&&(b.setStrokeColor("rgba(0,0,255,0.6)"),Grape2D.TopDownBVHTreeDebugger.renderNode(a.getRight(),b,c),b.setStrokeColor("rgba(0,0,0,1)"))},render:function(a,b,c){a.getRootNode()&&
Grape2D.TopDownBVHTreeDebugger.renderNode(a.getRootNode(),b,c)}};Grape2D.utils.NetworkDebugger={pingPos:new Grape2D.Vector(85,20),inPos:new Grape2D.Vector(20,35),inRatePos:new Grape2D.Vector(88,35),outPos:new Grape2D.Vector(20,50),outRatePos:new Grape2D.Vector(88,50),textFont:"13px Consolas",render:function(a,b,c){a=a.getMetrics();b.setTextFont(Grape2D.utils.NetworkDebugger.textFont);b.renderText("ping: "+a.getPing()+" ms",Grape2D.utils.NetworkDebugger.pingPos);b.renderText("in : "+a.getLastBytesReceived(),Grape2D.utils.NetworkDebugger.inPos);b.renderText(Grape2D.Math.roundTwo(a.getBytesReceivedPerSec())+
" k/s",Grape2D.utils.NetworkDebugger.inRatePos);b.renderText("out: "+a.getLastBytesSent(),Grape2D.utils.NetworkDebugger.outPos);b.renderText(Grape2D.Math.roundTwo(a.getBytesSentPerSec())+" k/s",Grape2D.utils.NetworkDebugger.outRatePos)}};if(NODE){module.exports = Grape2D;}else{window.Grape2D = Grape2D} })()
