...
Grape2D.utils={getDocumentSize:function(){return{width:document.width||document.documentElement.clientWidth,height:document.height||document.documentElement.clientHeight}},requestAnimationFrame:function(a){var b=0;a=["ms","moz","webkit","o"];for(var c=null,d=null,e=0;e<a.length&&!window.requestAnimationFrame;++e)c=window[a[e]+"RequestAnimationFrame"],d=window[a[e]+"CancelAnimationFrame"]||window[a[e]+"CancelRequestAnimationFrame"];c||(c=function(a,c){var d=(new Date).getTime(),e=Math.max(0,16-(d-
b)),l=window.setTimeout(function(){a(d+e)},e);b=d+e;return l});d||(d=function(a){clearTimeout(a)});Grape2D.utils.requestAnimationFrame=c;Grape2D.utils.cancelAnimationFrame=d},cancelAnimationFrame:function(){}};Grape2D.utils.Clock=function(){this.frameCount=0;this.lastFrame=this.end=this.start=(new Date).getTime();this.timeEl=this.fps=0};
...
Grape2D.Vector.createFromPoints=function(a,b){return new Grape2D.Vector(b.x-a.x,b.y-a.y)};Grape2D.Vector.createFromAngle=function(a,b){return new Grape2D.Vector(b*Grape2D.Math.cos(a),b*Grape2D.Math.sin(a))};Grape2D.Matrix=function(a,b,c,d,e,f,g,h,k){this.v=[];void 0!==a?this.v=[a,b,c,d,e,f,g,h,k]:this.identity()};
...
setStrokeColor:function(a){},setFillColor:function(a){}};Grape2D.Canvas=function(a){a||(a={});this.canvas=document.createElement("Canvas");this.canvas.width=this.width=a.width||300;this.canvas.height=this.height=a.height||150;this.halfWidth=this.width/2;this.halfHeight=this.height/2;this.context=this.getContext()};
Grape2D.Canvas.prototype={getWidth:function(){return this.width},getHalfWidth:function(){return this.halfWidth},setWidth:function(a){this.canvas.width=this.width=a;this.halfWidth=this.width/2},getHeight:function(){return this.height},getHalfHeight:function(){return this.halfHeight},setHeight:function(a){this.canvas.height=this.height=a;this.halfHeight=this.width/2},toDataURL:function(a,b){return this.context.toDataURL(a,b)},getContext:function(){return this.canvas.getContext("2d")},save:function(){this.context.save();
return this},restore:function(){this.context.restore();return this},scale:function(a,b){this.context.scale(a,b);return this},rotate:function(a){this.context.rotate(a);return this},translate:function(a,b){this.context.translate(a,b);return this},transform:function(a,b,c,d,e,f){this.context.transform(a,b,c,d,e,f);return this},drawImage:function(a,b,c,d,e,f,g,h,k){this.context.drawImage(a,b,c,d,e,f,g,h,k)},setGlobalAlpha:function(a){this.context.globalAlpha=a;return this},globalCompositeOperation:function(a){this.context.globalCompositeOperation=
...
Grape2D.CanvasRenderer.prototype.renderAABB=function(a,b){var c=a.getPosition().clone(),d=c.clone(),e=c.clone(),f=c.clone();d.x-=a.getHalfWidth();d.y-=a.getHalfHeight();d=b.wcsToViewport(this,d);e.x+=a.getHalfWidth();e.y-=a.getHalfHeight();e=b.wcsToViewport(this,e);c.x-=a.getHalfWidth();c.y+=a.getHalfHeight();c=b.wcsToViewport(this,c);f.x+=a.getHalfWidth();f.y+=a.getHalfHeight();f=b.wcsToViewport(this,f);this.canvas.beginPath();this.canvas.moveTo(d.x,d.y);this.canvas.lineTo(e.x,e.y);this.canvas.lineTo(f.x,
f.y);this.canvas.lineTo(c.x,c.y);this.canvas.lineTo(d.x,d.y);this.canvas.stroke()};Grape2D.CanvasRenderer.prototype.renderCircle=function(a,b){var c=b.wcsToViewport(this,a.getPosition());this.canvas.beginPath();this.canvas.arc(c.x,c.y,a.getRadius(),0,Grape2D.Math.PIx2,!1);this.canvas.stroke()};
...
Grape2D.InputManagerEvent.prototype={constructor:Grape2D.InputManagerEvent,getRaw:function(){return this.raw}};Grape2D.Camera=function(a){this.rscale=new Grape2D.Vector(1,1);this.scale=a.scale||new Grape2D.Vector(1,1);this.lookAt=a.lookAt||new Grape2D.Vector;this.transformation=a.transformation||new Grape2D.Matrix;this.cM=new Grape2D.Matrix;this.icM=new Grape2D.Matrix;this.computeMatrix()};
...
Grape2D.GenericCollisionChecker.prototype.polygonVsAabb=function(a,b){return this.aabbVsPolygon(b,a)};Grape2D.GenericCollisionChecker.prototype.polygonVsCircle=function(a,b){return this.circleVsPolygon(b,a)};Grape2D.GenericCollisionChecker.prototype.aabbVsPolygon=function(a,b){return!1};Grape2D.GenericCollisionChecker.prototype.circleVsPolygon=function(a,b){for(var c=b.getVertexList(),d=a.getPosition(),e=Grape2D.Math.sq(a.getRadius()),f=0;f<c.length;f++)if(c[f].sqDistanceTo(d)<=e)return!1;return!0};
...
Grape2D.SATCollisionChecker.prototype.aabbVsPolygon=function(a,b){return!1};Grape2D.SATCollisionChecker.prototype.polygonVsPolygon=function(a,b){for(var c=this.selectAxis(this.computeAxis(a.getVertexList()),this.computeAxis(b.getVertexList())),d=this.computeIntervals(a.getVertexList(),c),e=this.computeIntervals(b.getVertexList(),c),f,g=0;g<c.length;g++)if(f=Grape2D.Math.overlaps(d,e),0>f)return!1;return!0};
Grape2D.SATCollisionChecker.prototype.computeAxis=function(a){var b=[];a=a.getVertexList();var c,d;for(d=0;d<a.length;d++)c=(d+1)%a.length,b.push(Grape2D.Vector.createFromPoints(a[d],a[c]).normalize().rightNormal());return b};Grape2D.SATCollisionChecker.prototype.selectAxis=function(a,b){for(var c=[],d,e=0;e<a.length;e++)c.push(a);e=0;for(d=!0;e<c.length;e++,d=!0){for(var f=0;f<b.length;f++)c[e].isParallelTo(b[f])&&(d=!1);d&&c.push(b[e])}return c};
Grape2D.SATCollisionChecker.prototype.computeIntervals=function(a,b){for(var c=[],d=Infinity,e=-Infinity,f,g,h=0;h<b.length;h++){for(var d=Infinity,e=-Infinity,k=0;k<a.length;k++)f=a[k].dot(b[h]),g=a[(k+1)%a.length].dot(b[h]),f>e&&(e=f),f<d&&(d=f),g>e&&(e=g),g<d&&(d=f);c.push({min:d,max:e})}return c};Grape2D.SATCollisionChecker.aabbAxis=[new Grape2D.Vector(1,0),new Grape2D.Vector(0,1)];
Grape2D.CollisionDispatcher={aabbVsAabb:function(a,b,c){return a.aabbVsAabb(b,c)},aabbVsCircle:function(a,b,c){return a.aabbVsCircle(b,c)},aabbVsPolygon:function(a,b,c){return a.aabbVsPolygon(b,c)},aabbVsPoint:function(a,b,c){return a.aabbVsPoint(b,c)},circleVsAabb:function(a,b,c){return a.circleVsAabb(b,c)},circleVsCircle:function(a,b,c){return a.circleVsCircle(b,c)},circleVsPolygon:function(a,b,c){return a.aabbVsPolygon(b,c)},circleVsPoint:function(a,b,c){return a.circleVsPoint(b,c)},polygonVsAabb:function(a,
b,c){return a.polygonVsAabb(b,c)},polygonVsCircle:function(a,b,c){return a.polygonVsCircle(b,c)},polygonVsPolygon:function(a,b,c){return a.polygonVsPolygon(b,c)},polygonVsPoint:function(a,b,c){return a.aabbVsPolygon(b,c)},dcache:{},dispatch:function(a,b,c){return Grape2D.CollisionDispatcher.dcache[b.getStaticType()][c.getStaticType()](a,b,c)}};
...
Polygon:Grape2D.CollisionDispatcher.polygonVsPolygon,Point:Grape2D.CollisionDispatcher.polygonVsPoint}};Grape2D.CollisionCheckerSingleton={instance:new Grape2D.GenericCollisionChecker,getCollisionChecker:function(){return Grape2D.CollisionCheckerSingleton.instance},setCollisionChecker:function(a){Grape2D.CollisionCheckerSingleton.instance=a},collide:function(a,b){return Grape2D.CollisionDispatcher.dispatch(Grape2D.CollisionCheckerSingleton.instance,a,b)},contains:function(a,b){}};
Grape2D.BVHTree=function(){};Grape2D.BVHTree.prototype=Object.create(Grape2D.Map.prototype);Grape2D.TopDownBVHTree=function(a){this.objs=a||[];this.rootNode=null;this.objs.length&&this.rebuild()};Grape2D.TopDownBVHTree.prototype=Object.create(Grape2D.BVHTree.prototype);Grape2D.TopDownBVHTree.prototype.rebuild=function(){this.rootNode=new Grape2D.TopDownBVHNode(null,this.objs)};Grape2D.TopDownBVHTree.prototype.add=function(a){this.objs.push(a)};
Grape2D.TopDownBVHTree.prototype.remove=function(a){this.objs.splice(this.objs.indexOf(a),1)};Grape2D.TopDownBVHTree.prototype.query=function(a){return this.rootNode.query(a)};Grape2D.TopDownBVHTree.prototype.queryPoint=function(a){return this.rootNode.queryPoint(a)};Grape2D.TopDownBVHTree.prototype.clear=function(){this.objs=[];this.rootNode=null};Grape2D.TopDownBVHTree.prototype.update=function(a,b){for(var c=0;c<this.objs.length;c++)this.objs[c].update(a,b)};
Grape2D.TopDownBVHNode=function(a,b){this.bv=null;this.leaf=!1;this.objects=[];this.parent=a;this.right=this.left=null;this.depth=a?a.getDepth()+1:0;this.compute(b)};
Grape2D.TopDownBVHNode.prototype={constructor:Grape2D.TopDownBVHNode,compute:function(a){if(a.length<=Grape2D.TopDownBVHNode.DEFAULT_PER_LEAF||this.depth>=Grape2D.TopDownBVHNode.MAX_DEPTH){this.leaf=!0;for(var b=0;b<a.length;b++)this.objects.push(a[b])}else{var c=Grape2D.BVHStrategySingleton.getStrategy().solve(a),d=Grape2D.BVFactorySingleton.getFactory();this.bv=d.merge(a[0].getBoundingBox(),a[1].getBoundingBox());for(b=2;b<a.length;b++)this.bv=d.merge(this.bv,a[b].getBoundingBox());this.left=new Grape2D.TopDownBVHNode(this,
...
this.bv)){var d=this.left.query(a);for(c=0;c<d.length;c++)b.push(d[c]);d=this.right.query(a);for(c=0;c<d.length;c++)b.push(d[c])}return b},queryPoint:function(a){var b=[],c;if(this.leaf)for(c=0;c<this.objects.length;c++)Grape2D.CollisionCheckerSingleton.contains(a,this.objects[c].getBoundingBox())&&b.push(this.objects[c]);else{if(Grape2D.CollisionCheckerSingleton.contains(a,this.bv)){var d=this.left.queryPoint(a);for(c=0;c<d.length;c++)b.push(d[c]);d=this.right.queryPoint(a);for(c=0;c<d.length;c++)b.push(d[c])}return b}},
getDepth:function(){return this.depth}};Grape2D.TopDownBVHNode.DEFAULT_PER_LEAF=2;Grape2D.TopDownBVHNode.MAX_DEPTH=50;Grape2D.BVHStrategy=function(){};Grape2D.BVHStrategy.prototype={constructor:Grape2D.BVHStrategy,solve:function(a){}};Grape2D.MedianCutBVHStrategy=function(){};Grape2D.MedianCutBVHStrategy.prototype=Object.create(Grape2D.BVHStrategy.prototype);
Grape2D.MedianCutBVHStrategy.prototype.solve=function(a){for(var b={left:[],right:[]},c=Infinity,d=-Infinity,e=Infinity,f=-Infinity,g=0,h,k=0;k<a.length;k++)h=a[k].getBoundingBoxPosition(),c>h.getX()&&(c=h.getX()),d<h.getX()&&(d=h.getX()),e>h.getY()&&(e=h.getY()),f<h.getY()&&(f=h.getY());if(c+d>=e+f)for(g=(d+c)/2,k=0;k<a.length;k++)h=a[k].getBoundingBoxPosition(),h.getX()>g?b.right.push(a[k]):b.left.push(a[k]);else for(g=(f+e)/2,k=0;k<a.length;k++)h=a[k].getBoundingBoxPosition(),h.getY()>g?b.right.push(a[k]):
b.left.push(a[k]);return b};Grape2D.BVHStrategySingleton={strategy:new Grape2D.MedianCutBVHStrategy,setStrategy:function(a){Grape2D.BVHStrategySingleton.strategy=a},getStrategy:function(){return Grape2D.BVHStrategySingleton.strategy}};Grape2D.BVFactory=function(){};Grape2D.BVFactory.prototype={constructor:Grape2D.BVFactory,createFromAABB:function(a){},createFromCircle:function(a){},createFromPolygon:function(a){},createSceneBV:function(a,b){}};Grape2D.AabbBVFactory=function(){};
...
Grape2D.AabbBVFactory.prototype.merge=function(a,b){var c=b.getPosition().getX()-a.getPosition().getX(),d=b.getPosition().getY()-a.getPosition().getY(),e,f=new Grape2D.Vector;Grape2D.Math.abs(c)+b.getHalfWidth()<=a.getHalfWidth()?(c=a.getWidth(),f.setX(a.getPosition().getX())):(c=Grape2D.Math.abs(c)+b.getHalfWidth()+a.getHalfWidth(),e=a.getPosition().getX()>=b.getPosition().getX()?a.getPosition().getX()+a.getHalfWidth()-c/2:a.getPosition().getX()-a.getHalfWidth()+c/2,f.setX(e));Grape2D.Math.abs(d)+
b.getHalfHeight()<=a.getHalfHeight()?(d=a.getHeight(),f.setY(a.getPosition().getY())):(d=Grape2D.Math.abs(d)+b.getHalfHeight()+a.getHalfHeight(),e=a.getPosition().getY()>=b.getPosition().getY()?a.getPosition().getY()+a.getHalfHeight()-d/2:a.getPosition().getY()-a.getHalfHeight()+d/2,f.setY(e));return new Grape2D.AABB({width:c,height:d,position:f})};
Grape2D.BVFactorySingleton={bvfactory:new Grape2D.AabbBVFactory,getFactory:function(){return Grape2D.BVFactorySingleton.bvfactory},setFactory:function(a){Grape2D.BVFactorySingleton.bvfactory=a},create:function(a){return a.createBV(Grape2D.BVFactorySingleton.bvfactory)}};Grape2D.ITexture=function(){};
